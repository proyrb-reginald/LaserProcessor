...
void MX_LTDC_Init(void)
{
  ...
  hltdc.Init.AccumulatedActiveW = 824;
  hltdc.Init.AccumulatedActiveH = 1302;
  hltdc.Init.TotalWidth = 864;
  hltdc.Init.TotalHeigh = 1332;
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOG, GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_14);
